  ...
  <div class="body">
    ...
    <div class="gameplay" v-show="isPlay == 2">
      <div class="rule" v-if="RuleButton == true">
        ...
        <div class="rule-body">
          <p style="color: black">
            - ผู้เล่นจะต้องนำค่าของการ์ดที่ได้มาบวกกันให้เท่ากับหรือใกล้เคียง 21
            มากที่สุด
          </p>
          <p style="color: black">
            - โดยจะสามารถเลือก
          ...
          <p style="color: black">
            - หากผู้เล่นฝ่ายใดมีค่าเท่ากับหรือใกล้เคียง 21 มากที่สุด
            จะเป็นผู้ชนะ
          </p>
          <p style="color: black">
            - ในกรณีที่ฝ่ายใดมีค่ามากกว่า 21 จะหมดสิทธิ์ชนะในทันที
          </p>
          <p style="color: black">
            - แต่หากทั้งคู่มีค่ามากกว่า 21 จะถือว่าเสมอ
          </p>
        </div>
      </div>
      ...
      <div class="field-game" v-show="GameField">
        ...
        <p class="score-board">
          Score Board <br />
          <a style="color: #ede682">{{ player.name }}</a> | {{ player.score }} :
          {{ bot.score }} | <a style="color: #ea99d5">{{ bot.name }}</a> <br />
          Round : {{ round }}
        </p>
        ...
        <div class="center">
          ...
          <p :style="centerStyle" v-if="turn == 0">
            Turn Of <a style="color: #ede682">{{ player.name }}</a>
          </p>
          <p :style="centerStyle" v-else-if="turn == 1">
            Turn Of <a style="color: #ea99d5">{{ bot.name }}</a>
          </p>
          <div v-else>
        ...
        <p class="player-score">
          <a style="color: #ede682">{{ player.name }}</a> : {{ sumOfplayer }}
        </p>
     ...
     <div class="beforeplaygame" v-if="GameField == false">
